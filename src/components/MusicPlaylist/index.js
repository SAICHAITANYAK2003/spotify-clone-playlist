...
class MusicPlaylist extends Component {
  ...
  onClickDeleteTrack = id => {
    ...
    const updatedPlayList = playList.filter(eachMusic => eachMusic.id !== id)
    this.setState({playList: updatedPlayList})
  }

  renderNoFound = () => (
    <EmptyContainer>
      <EmptyName>No Songs Found</EmptyName>
    </EmptyContainer>
  )
  ...
  render() {
    ...
    return (
      <MusicPlaylistContainer>
        ...
        <SongsPlayList>
          <SongsPlayListHeader>Songs Playlist</SongsPlayListHeader>
          <SearchInputContainer>
            <SongsSearchInput
              value={searchInput}
              type="search"
